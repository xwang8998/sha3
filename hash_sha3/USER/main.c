...
int test_sha3()
{
    ...
    const char *testvec[][2] = {
        {   // SHA3-224, corner case with 0-length message
            "6162636465666768616263646566676861626364656667686162636465666768",
            "6B4E03423667DBB73B6E15454F0EB1ABD4597F9A1B078E3F5B5A6BC7"
        },
        {   // SHA3-256, short message  abc  616263
            "616263",
...
//        }
//					 if (memcmp(sha, buf, sha_len) == 0) {
//            fprintf(stderr, "[%d] SHA3-%d, len %d test ok.\n", i, sha_len * 8, msg_len);
//						 for(i=0;i<64;i++)
//						 {
//						 printf("%d %X %X %X\n",i,sha[i],buf[i],msg[255-i]);
//						 }
...
int main(int argc, char **argv)
{
	...
	//if (test_sha3() == 0 && test_shake() == 0)
				printf("FIPS 202 / SHA3  Self-Tests [start]!\n");
				test_sha3();
        printf("FIPS 202 / SHA3  Self-Tests [end]!\n");
    //test_speed();
